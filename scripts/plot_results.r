...
stats.average.reward.plot <- ggplot(stats, aes(x = t, y = V1, color = epsilon.value))
stats.average.reward.plot + geom_line() + ylim(0, 1) + xlab("Time (Iteration No.)") + ylab("Average Reward") + ggtitle("Epsilon-Greedy Performance")
